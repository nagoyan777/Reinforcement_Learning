    ...
    def learn(self,
        ...
        for e in range(episode_count):
            ...
            while not done:
                ...
                # Update from experiments in real environment.
            ...
            if e != 0 and e % report_interval == 0:
                ...
                print(f"At episode {e}, reward is {recent.mean()}")
...
class Model():
    ...
    def simulate(self, count):
        ...
        def actions(s):
            return [a for a, c in self.history[s].most_common() if c > 0]
